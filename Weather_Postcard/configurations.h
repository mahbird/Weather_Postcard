...
const char* pass = "yourPassword"; // replace with your password

int updateinterval = 1; // default update interval = 1 hour
int sleephour = 22;// the hour of the last update, if previous update time + interval > sleep hour, it will still update one more time at interval before sleeping.
...
String rainlocation = "Sha Tin"; // Rainfall location, see "locations.h" for list
String tmpClocation = "Sha Tin"; // Temperature location, see "locations.h" for list
